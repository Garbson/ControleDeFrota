...
<template>
  <aside class="sidebar w-[220px] flex-shrink-0 flex flex-col overflow-hidden">
    ...
    <div class="px-3 pt-3 pb-2 flex-shrink-0">
      <img src="/logo-triunfo.png" alt="Transportadora Triunfo" class="logo-img" />
    </div>
      ...
      <template v-for="section in menuSections" :key="section.title">
        ...
        >
          <span class="icon-wrap">
            ...
            <svg v-else-if="item.icon==='suppliers'" width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/></svg>
