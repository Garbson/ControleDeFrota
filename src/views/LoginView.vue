      ...
      <div class="login-card px-8 py-8">
        ...
        <form @submit.prevent="submit" class="space-y-4">
          <div>
            ...
            <input id="login-email" v-model="email" type="email" placeholder="seu@email.com" autocomplete="email" required class="field-input" />
          </div>
          <div>
            <label for="login-password" class="field-label">Senha</label>
            <div class="relative">
              <input id="login-password" v-model="password" :type="showPass ? 'text' : 'password'" placeholder="••••••••" autocomplete="current-password" required class="field-input pr-11" />
